...
Überprüft das aktuelle Schema der users Tabelle
"""
...
def check_postgresql_schema():
    """Überprüft das aktuelle Schema der PostgreSQL users Tabelle"""
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if 'hashed_password' in column_names:
                ...
                print("\n❌ hashed_password column MISSING")
                return False
...
if __name__ == "__main__":
    print("🔍 PostgreSQL Schema Check für deployed Version")
    print("=" * 50)
    
    has_hashed_password = check_postgresql_schema()
    
    if has_hashed_password:
        print("\n✅ Schema is correct - hashed_password column exists!")
        print("The OAuth Microsoft login should work.")
    else:
        print("\n❌ Schema is missing hashed_password column!")
