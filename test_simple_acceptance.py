...
async def test_simple_acceptance():
    """Test a simpler acceptance endpoint"""
        ...
        try:
            ...
            if login_response.status_code == 200:
                ...
                if token:
                    ...
                    print("Testing simple acceptance endpoint...")
                    
                    # Test the basic acceptance endpoint
...
if __name__ == "__main__":
    asyncio.run(test_simple_acceptance())
