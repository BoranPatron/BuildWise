#!/usr/bin/env python3
"""
Sofortige Datenbank-Behebung für Geo-Karten-Problem
"""
...
async def fix_database_immediately():
    """Behebt die Datenbank sofort"""
    print("🚀 SOFORTIGE DATENBANK-BEHEBUNG...")
    ...
    try:
        ...
        # Verwende die korrekten Credentials
...
async def main():
    """Hauptfunktion"""
    print("🚀 Starte sofortige Datenbank-Behebung...")
    
    try:
        # 1. Datenbank beheben
        db_success = await fix_database_immediately()
