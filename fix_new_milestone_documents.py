#!/usr/bin/env python3
"""
Skript zum Hinzufügen der Dokumente zum neuen Gewerk (Milestone 1)
"""
...
async def fix_new_milestone_documents():
    """Fügt die Dokumente zum neuen Gewerk (Milestone 1) hinzu"""
    ...
    async with engine.begin() as conn:
        try:
            print("🔍 Füge Dokumente zum neuen Gewerk (Milestone 1) hinzu...")
            
            # Sammle alle Dokumente aus dem storage Verzeichnis
                ...
                for root, dirs, files in os.walk(storage_path):
                    for file in files:
                        ...
                        document_data = {
                            ...
                            "file_name": file,
                            "file_path": f"/storage/uploads/{relative_path.replace(os.sep, '/')}",
                            "file_size": file_size,
                            "mime_type": mime_type,
            ...
            if real_documents:
                ...
                print(f"\n✅ {len(real_documents)} Dokumente zu Milestone 1 hinzugefügt!")
...
if __name__ == "__main__":
    asyncio.run(fix_new_milestone_documents()) 